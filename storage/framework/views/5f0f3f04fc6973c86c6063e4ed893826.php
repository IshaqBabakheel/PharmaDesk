                        ...
                        <select id="filter_event" class="form-select">
                            ...
                            <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($event); ?>">
                                    <?php echo e(ucfirst(str_replace('_', ' ', $event))); ?>
                        ...
                        <select id="filter_log_name" class="form-select">
                            ...
                            <?php $__currentLoopData = $logNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $logName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($logName); ?>">
                                    <?php echo e(ucfirst(str_replace('_', ' ', $logName))); ?>
    ...
    <script>
        $(function() {
            const table = $('#activityLogsTable').DataTable({
                ...
                ajax: {
                    url: <?php echo json_encode(route('audit-logs.datatable'), 15, 512) ?>,
                    data: function(data) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PharmaDesk\resources\views/audit_logs/index.blade.php ENDPATH**/ ?>