...
<?php $__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('roles.partials.stats', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <div class="card shadow-sm mb-4">
        <div class="card-body">
            
            <?php echo $__env->make('components.filter-buttons', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.create')): ?>
                <a href="<?php echo e(route('roles.create')); ?>" class="btn btn-primary float-end">
    ...
    <script>
        $(function() {
            ...
            $('#rolesTable').DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('roles.datatable')); ?>",
                    data: function(d) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PharmaDesk\resources\views/roles/index.blade.php ENDPATH**/ ?>